            ...
            <div class="card-content">
                <form action="<?= URL_RAIZ . 'produtos' ?>" method="post" enctype="multipart/form-data" class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            <select name="id_categoria" value="<?= $this->getPost('id_categoria') ?>">
                    ...
                    <div class="row">
                        ...
                        <label class="black-text active">Valor <span class="red-text">*</span></label>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <div class="center">
                                        ...
                                        <h5 class="cor-texto-primaria center">Foto de Prato</h5>
